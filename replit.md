...
A Python Flask BIM clash detection web app is available from the project root for Render deployment. Root deployment files include `app.py`, `main.py`, `clash_detector.py`, `pdf_export.py`, `requirements.txt`, `templates/`, `static/`, and `storage/`.
...
- `requirements.txt` — Render-compatible Python dependencies, including IfcOpenShell 0.7.0 direct Linux wheel URL
